...
<img src="./src/static/images/weatherMainPage.png" alt="Screenshot of the app (Day)." width="45%" height="45%"> 
<img src="./src/static/images/pmMainPage.png" alt="Screenshot of the app (Night)." width="45%" height="45%">
...
<img src="./src/static/images/changeLang.png" alt="Change language." width="45%" height="45%"> <img src="./src/static/images/changeTempUnit.png" alt="Change temperature unit." width="45%" height="45%"> <img src="./src/static/images/weatherMoreInfo.png" alt="Change temperature unit." width="45%" height="45%"> <img src="./src/static/images/pmMoreInfo.png" alt="Change temperature unit." width="45%" height="45%">
